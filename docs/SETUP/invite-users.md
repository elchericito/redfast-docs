...
next:
  description: ''
---
Administrators can invite team members to individual apps. To grant a user permissions to use multiple apps you must invite them to each app.

Only company/app admins can modify app settings and invite users.
