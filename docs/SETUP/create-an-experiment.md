...
- [ ] Now go to your prompt and add the custom goal
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/b7ac98d-image.png",null,null],"align":"center","border":true}]}[/block]

  [block:image]{"images":[{"image":["https://files.readme.io/ae3bdf1-image.png",null,null],"align":"center","border":true}]}[/block]
