...
- [ ] Find a usage tracker you're interested in  
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/c80c651-image.png",null,""],"align":"center","border":true}]}[/block]
...
- [ ] Go to to the **Custom Goal** section and click the** Add custom goal** button
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/ea36176-image.png",null,null],"align":"center","border":true}]}[/block]
- [ ] Select the goal tracker from the drop-down list, set the attribution duration and hit **Save**

  [block:image]{"images":[{"image":["https://files.readme.io/075d4bd-image.png",null,""],"align":"center","border":true}]}[/block]
- [ ] Publish your prompt.
