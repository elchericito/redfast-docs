...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f4f061d7ef9fb6a4431a7729f086f644fc8e4be964a70e48329b84af7d870f63-image.png",
        null,
        ""
      ],
      "align": "center",
...
**Global Holdout** allows you to set up a percentage of users who will never experience any of the Redfast prompts.  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d4d64b2-image.png",
        null,
        ""
      ],
      "align": "center",
...
**Global Frequency Cap** allows you to set the maximum number of prompts a user can be shown within a specified time range. For example, with the settings below, a signle user can see no more than 10 prompts within 30 days. After 30 days, the cap is reset. 
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/50c0908-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ad648f7-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/e9f0c59531668b8b7da64d915c0cc155e828c69edc4c1106ff079f8456972c88-image.png",
        null,
        ""
      ],
      "align": "center",
