...
- [ ] Select a connector, i.e., Zuora
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/2bae331-image.png",null,""],"align":"center","border":true}]}[/block]

- [ ] Fill in the required data

  [block:image]{"images":[{"image":["https://files.readme.io/5f1e9d9-image.png",null,""],"align":"center","border":true}]}[/block]

- [ ]  Set the toggle to 'Active' and hit 'Save changes'.

  [block:image]{"images":[{"image":["https://files.readme.io/dbee0b4-image.png",null,""],"align":"center","border":true}]}[/block]
