...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a4de93b-roku-inapp.png",
        "",
        ""
      ],
      "align": "center",
...
2. Define one or more Product IDs (should match those configured within App Store Connect)
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/d01be52-apple-add-inapp-product.png","",""],"align":"center","sizing":"600px"}]}[/block]
3. Go to Prompt Edit Screen and specify Product ID within In-App Purchase section

   [block:image]{"images":[{"image":["https://files.readme.io/f500c36-appstore-select-inapp.png","",""],"align":"center","sizing":"500px"}]}[/block]
